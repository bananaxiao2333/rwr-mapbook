...
<p class="kicker">TABLES · 七百多個物件，能不能用</p>

五張表，來自編輯組維護的那份 Excel（原文標着**模板版本 vao0822**）。
每一行是一個物件：預覽圖、它是什麼、以及組裡記的備註。

| 頁 | 內容 | 條目 |
| --- | --- | --- |
| [MESH E](mesh.md) | 石頭、植物、小物件、大物件、特殊物件，以及有嚴重問題的物件 | 136 |
| [Wall E](wall.md) | 正常牆與特殊牆 | 49 |
