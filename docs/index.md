...
<p class="kicker">RWR 地图编辑组 · 内部资料</p>
...
!!! warning "先说清楚这是什么"
    这是编辑组的**内部工作记录**，不是官方说明书。原文标着「待试」「未录入」的地方
    照原样留着——那表示**组里还没试过**，不代表能用，也不代表不能用。
...
**版本**决定你看到哪一版地编的说明，**语言**决定用哪种文字读。两者互不干涉：
换版本不会换语言，换语言也不会回版本。
